...
public class CommonUtil {
	...
	/**
	 * Method getDensity() used to get the Device's Density. With this function,
	 * we can use for checking the device's density and supporting for other
	 * devices.
	 * 
	 * @param context
	...
	/**
	 * Method getScreenSize() used to get the Device's Screen Size. Using this
	 * function, we can use this function for getting the ScreenSize for
	 * supporting the multiple screen compability.
	 * 
	 * @param context
	 *            The Application Context.
	 * @return Size Type.
	...
	/***
	 * Method getDisplaySize() used to get the Display's Size. Using this
	 * function or method for checking the display's size. It will return the
	 * amount of real display's size followed by 2 direction: horizontal and
	 * vertical.
	 * 
	 * @param context
	 *            The Application Context.
	...
	public static boolean isLargeOrXLarge(Context context) {
		...
		return (mask == Configuration.SCREENLAYOUT_SIZE_XLARGE)
				|| (mask == Configuration.SCREENLAYOUT_SIZE_LARGE);
	}
