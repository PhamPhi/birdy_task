...
public abstract class FragmentBase extends SherlockFragment{
    public static final String TAG = Properties.PREFIX + FragmentBase.class.getSimpleName();
    ...
    // Invalidating the data when the View will be notified by the Service Components.
