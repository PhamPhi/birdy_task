package com.frm.bdTask.activities.cusviews.abstracts;
...
import com.frm.bdTask.activities.cusviews.StackAdapter;
import com.frm.bdTask.activities.cusviews.SwipeDismissTouchListener;
...
public class CardStack extends AbstractCard {
    ...
    public View getView(Context context, View convertView, boolean swipable) {
        ...
        for (int i = 0; i < cardsArraySize; i++) {
            ...
            if (i > 0) {
                ...
                topPx = CommonUtil.convertDpToPixelInt(context, dp);
            }
            ...
            if (swipable) {
                cardView.setOnTouchListener(new SwipeDismissTouchListener(
                        cardView, card, new SwipeDismissTouchListener.OnDismissCallback() {
    ...
    protected float convertDpToPixel(float dp) {
        ...
        return CommonUtil.convertDpToPixel(mContext, dp);
    }
    ...
    private AnimatorListener getAnimationListener(final CardStack cardStack,
        ...
        return new AnimatorListener() {
            ...
            private void handleFirstCard(View newFirstCard) {
                ...
                top = 2 * CommonUtil.convertDpToPixelInt(mContext, 8)
                        + CommonUtil.convertDpToPixelInt(mContext, 1);
                bottom = CommonUtil.convertDpToPixelInt(mContext, 12);

                lp.setMargins(0, top, 0, bottom);
                newFirstCard.setLayoutParams(lp);
                newFirstCard.setPadding(0,
                        CommonUtil.convertDpToPixelInt(mContext, 8), 0, 0);
